    ...
    <div class="top-10 h-full max-w-[800px] flex items-center justify-center dark:bg-gray-700">
      ...
      <div class="relative p-4 w-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          >
            <button title="Descargar Comprobante" type="button" (click)="downloadReport()" class="text-green-600 hover:text-green-800 dark:text-green-300 dark:hover:text-green-500">
              <svg
            ...
            <button title="Imprimir Comprobante" type="button" (click)="printReport()" class="pl-4 text-green-600 hover:text-green-800 dark:text-green-300 dark:hover:text-green-500">
              <svg
            ...
            <button
              type="button"
              (click)="closeDialog()"
              class="end-2.5 text-gray-400 bg-transparent hover:bg-green-200 hover:text-green-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-red-600 dark:hover:text-white"
            >
              <svg
                class="w-3 h-3"
                aria-hidden="true"
